...
!!! info "At a Glance"
    ...
    | **Serogroup** | O:7 (C1) |
    | **NCBI Pathogen Detection** | [View isolates](https://www.ncbi.nlm.nih.gov/pathogens/isolates#taxgroup_name:("Salmonella%20enterica")%20AND%20computed_types:("serotype=Braenderup")) |
