...
!!! info "At a Glance"
    ...
    | **Serogroup** | O:7 (C1) |
    | **NCBI Pathogen Detection** | [View isolates](<https://www.ncbi.nlm.nih.gov/pathogens/isolates/#(taxgroup_name:%22Salmonella%20enterica%22)%20AND%20computed_types:(%22serotype=Mikawasima%22)>) |
